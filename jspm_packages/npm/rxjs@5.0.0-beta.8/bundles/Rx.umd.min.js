    ...
    return function a(b, f, h) {
      ...
      7: [function(a, b, f) {
        ...
        a = function() {
          ...
          a.prototype.call = function(a, b) {
            return b._subscribe(new h.Subscriber(a));
          };
          return a;
        }();
        f.Operator = a;
      ...
      141: [function(a, b, f) {
        ...
        a = function(a) {
          function d(c, e, d, n) {
            ...
            this.arrayLike = c;
            this.scheduler = n;
            e || n || 1 !== c.length || (this._isScalar = !0, this.value = c[0]);
            e && (this.mapFn = e.bind(d));
          }
          h(d, a);
          d.create = function(a, e, m, n) {
            var b = a.length;
            return 0 === b ? new l.EmptyObservable : 1 !== b || e ? new d(a, e, m, n) : new k.ScalarObservable(a[0], n);
          };
      ...
      143: [function(a, b, f) {
        function h(a) {
          ...
          var f = g.callbackFunc,
              ...
              q = g.subject;
          if (!q) {
            var q = g.subject = new e.AsyncSubject,
                v = function C() {
                  for (var a = [],
                  ...
                  var m = C.source,
                      e = m.selector,
                      m = m.subject;
                  e ? (a = d.tryCatch(e).apply(this, a), a === c.errorObject ? b.add(u.schedule(l, 0, {
                    err: c.errorObject.e,
                    subject: m
                  })) : b.add(u.schedule(k, 0, {
                    value: a,
                    subject: m
                  }))) : b.add(u.schedule(k, 0, {
            ...
            v.source = g;
            d.tryCatch(f).apply(this, h.concat(v)) === c.errorObject && q.error(c.errorObject.e);
          }
          b.add(q.subscribe(a));
        }
        function k(a) {
        ...
        a = function(a) {
          ...
          b.prototype._subscribe = function(a) {
            ...
            g || (g = this.subject = new e.AsyncSubject, n = function x() {
              for (var a = [],
                  e = 0; e < arguments.length; e++)
                a[e - 0] = arguments[e];
              var m = x.source,
                  e = m.selector,
                  m = m.subject;
              e ? (a = d.tryCatch(e).apply(this, a), a === c.errorObject ? m.error(c.errorObject.e) : (m.next(a), m.complete())) : (m.next(1 === a.length ? a[0] : a), m.complete());
            }, n.source = this, d.tryCatch(m).apply(this, b.concat(n)) === c.errorObject && g.error(c.errorObject.e));
            return g.subscribe(a);
          };
          return b;
        }(b.Observable);
            ...
            var q = g.subject = new e.AsyncSubject,
                v = function C() {
                  ...
                  var m = C.source,
                      ...
                      m = m.subject,
                      g = a.shift();
                  g ? m.error(g) : e ? (a = d.tryCatch(e).apply(this, a), a === c.errorObject ? b.add(u.schedule(l, 0, {
                    err: c.errorObject.e,
                    subject: m
                  })) : b.add(u.schedule(k, 0, {
                    value: a,
      ...
      145: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          e.prototype.connect = function() {
            ...
            a || (a = this.source.subscribe(new d(this.getSubject(), this)), a.isUnsubscribed ? (this._connection = null, a = g.Subscription.EMPTY) : this._connection = a);
            return a;
          };
        ...
        var d = function(a) {
          ...
          c.prototype._unsubscribe = function() {
            ...
            a && (this.connectable = null, a._refCount = 0, a._subject = null, a._connection = null);
          };
          return c;
        }(b.SubjectSubscriber),
            c = function() {
            ...
            e = function(a) {
              ...
              c.prototype._unsubscribe = function() {
                ...
                if (a) {
                  ...
                  else if (a._refCount = c - 1, 1 < c)
                    this.connection = null;
                  else if (a = this.connection)
                    this.connection = null, a.unsubscribe();
                } else
                  this.connection = null;
              };
              return c;
      ...
      151: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          c.prototype._subscribe = function(a) {
            var c = this.removeHandler,
                d = this.selector,
                b = d ? function(c) {
                  var m = l.tryCatch(d).apply(null, arguments);
                  m === g.errorObject ? a.error(m.e) : a.next(m);
                } : function(c) {
                  a.next(c);
                },
                f = l.tryCatch(this.addHandler)(b);
            f === g.errorObject && a.error(f.e);
      ...
      152: [function(a, b, f) {
        ...
        a = function(a) {
          ...
          b.create = function(a, f, h, p) {
            var q = null,
                z = null;
            l.isFunction(f) ? (q = p || null, z = f) : d.isScheduler(q) && (q = f);
            if (null != a) {
              if ("function" === typeof a[u])
                return a instanceof t.Observable && !q ? a : new b(a, q);
              if (k.isArray(a))
                return new m.ArrayObservable(a, q);
              if (g.isPromise(a))
                return new c.PromiseObservable(a, q);
              if ("function" === typeof a[r.$$iterator] || "string" === typeof a)
                return new e.IteratorObservable(a, null, null, q);
              if (a && "number" === typeof a.length)
                return new n.ArrayLikeObservable(a, z, h, q);
            }
          ...
          b.prototype._subscribe = function(a) {
            var c = this.ish,
                e = this.scheduler;
            return null == e ? c[u]().subscribe(a) : c[u]().subscribe(new p.ObserveOnSubscriber(a, e, 0));
          };
          return b;
        }(t.Observable);
        f.FromObservable = a;
        ...
        a = function(a) {
          function b(e, g, f, r) {
            ...
            if (l.isObject(g))
              ...
              this.project = g, this.thisArg = f, this.scheduler = r;
            else if (null != g)
        ...
        var u = function(a) {
          ...
          c.prototype.next = function(a) {
            ...
            var c = this.resultSelector,
                e = this.destination;
            a = new q(a, this.xhr, this.request);
            c ? (c = r.tryCatch(c)(a), c === t.errorObject ? this.error(t.errorObject.e) : e.next(c)) : e.next(a);
          };
          c.prototype.send = function() {
            var a = this.request,
                ...
                n = c.headers,
                c = c.body,
                f = r.tryCatch(a.createXHR).call(a);
            if (f === t.errorObject)
              this.error(t.errorObject.e);
            else {
              this.xhr = f;
              var l = void 0,
                  l = e ? r.tryCatch(f.open).call(f, d, b, m, e, g) : r.tryCatch(f.open).call(f, d, b, m);
              l === t.errorObject ? this.error(t.errorObject.e) : (f.timeout = a.timeout, f.responseType = a.responseType, this.setHeaders(f, n), this.setupEvents(f, a), c ? f.send(c) : f.send());
            }
          };
          ...
          c.prototype.setupEvents = function(a, c) {
            ...
            a.upload && "withCredentials" in a && n.root.XDomainRequest && (e && (a.onprogress = function w(a) {
              ...
              var c = w.progressSubscriber,
                  ...
                  d = w.request;
              c && c.error(a);
              e.error(new v("ajax error", this, d));
            ...
            a.onreadystatechange = function w(a) {
              ...
              if (4 === this.readyState) {
                ...
                0 === b && (b = m ? 200 : 0);
                200 <= b && 300 > b ? (e && e.complete(), c.next(a), c.complete()) : (e && e.error(a), c.error(new v("ajax error " + b, this, d)));
              }
            };
      ...
      171: [function(a, b, f) {
        ...
        a = function(a) {
          function b(d, m) {
            ...
            "string" === typeof d ? this.url = d : r.assign(this, d);
            ...
            m = function(a) {
              ...
              e.prototype._group = function(a, e) {
                ...
                if (this.elementSelector)
                  ...
                  f = a;
                if (!m && (b.set(e, m = new g.Subject), b = new r(e, m, this), this.destination.next(b), this.durationSelector)) {
                  b = void 0;
                  try {
                    b = this.durationSelector(new r(e, m));
                  } catch (l) {
                    this.error(l);
                    return;
                  }
      ...
      282: [function(a, b, f) {
        ...
        var g = function() {
          ...
          a.prototype.call = function(a, c) {
            return c._subscribe(new d(a, this.windowBoundaries));
          };
          return a;
        }(),
            d = function(a) {
            ...
            g = function(a) {
              ...
              c.prototype._next = function(a) {
                for (var c = 0 < this.startWindowEvery ? this.startWindowEvery : this.windowSize,
                  ...
                  f[h].next(a);
                a = this.count - d + 1;
                0 <= a && 0 === a % c && f.shift().complete();
                0 === ++this.count % c && (c = new k.Subject, f.push(c), b.add(c), b.next(c));
              };
              c.prototype._error = function(a) {
          ...
          return a;
            ...
            e = function(a) {
              ...
              c.prototype.openWindow = function(a) {
                ...
                this.destination.next(a);
                var c = l.tryCatch(this.closingSelector)();
                c === g.errorObject ? (a = g.errorObject.e, this.destination.error(a), this.window.error(a)) : (this.add(this.closingNotification = d.subscribeToResult(this, c)), this.add(a));
              };
              return c;
            }(b.OuterSubscriber);
      }, {
        ...
        var n = function(a) {
          ...
          c.prototype._next = function(a) {
            var c = this.iterators,
                b = this.index++;
            g.isArray(a) ? c.push(new t(a)) : "function" === typeof a[e.$$iterator] ? c.push(new r(a[e.$$iterator]())) : c.push(new p(this.destination, this, a, b));
          };
          c.prototype._complete = function() {
        ...
        a = function(a) {
          ...
          b.parseMarbles = function(a, c, b, d) {
            ...
            for (var e = a.length,
                ...
                m = -1,
                A = 0; A < e; A++) {
              var E = A * this.frameTimeFactor + h,
                  y = void 0,
                  z = a[A];
              switch (z) {
                case "-":
                ...
                case ")":
                  ...
                  break;
                case "|":
                  y = l.Notification.createComplete();
                  break;
                case "^":
                  break;
                case "#":
                  y = l.Notification.createError(b || "error");
                  break;
                default:
                  y = l.Notification.createNext(k(z));
              }
              y && f.push({
                frame: -1 < m ? m : E,
                notification: y
